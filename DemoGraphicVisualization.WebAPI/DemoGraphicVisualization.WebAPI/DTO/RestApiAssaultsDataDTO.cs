...
namespace DemoGraphicVisualization.WebAPI.DTO
{
    ...
    public class AssaultGetCategory
    {
    ...
    public class AssaultTimeCategory
    {
        [DeserializeAs(Name = "index")]
        public Dictionary<string, int> Indexes { get; set; }
        [DeserializeAs(Name = "label")]
    ...
    public class RestApiAssaultsDataDTO
    {
        ...
        public AssaultDimension Dimensions { get; set; }
